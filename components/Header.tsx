...
import { ChevronDownIcon, ChatBubbleLeftIcon, HomeIcon, PhoneIcon, PaperAirplaneIcon, PlayCircleIcon } from "@heroicons/react/20/solid"
    ...
    return (
        <header className='bg-[#013B94]'>
            ...
            >
                ...
                <Popover.Group className="hidden lg:flex lg:gap-x-12" >
                    <Popover className="relative">
                        <Popover.Button
                            className="flex items-center gap-x-1 text-sm front-semibold leading-6 text-white"
                        >
                            Stays
                            <ChevronDownIcon
                        ...
                        <Transition
                            as={Fragment}
                            enter='transition eas-out duration-200'
                            ...
                            >
                                ...
                                <div className="grid grid-cols-2 divide-x divide-gray-900/5 bg-gray-50">
                                    {callsToAction.map((item) => (
                                        ...
                                        >
                                            <item.icon
                                                className='h-5 w-5 flex-none text-[#13B94]'
                                                aria-hidden="true"
                                            />
                                            {item.name}
                                        </a>
            ...
            >
                ...
                <Dialog.Panel
                    className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-[#013B94] px-6 py-6 sm:max-w-sm sm:right-1 sm: ring-gray-900/10"
                >
                    ...
                    <div className="mt-6 flow-root">
                        <div className="-my-6 divide-y divide-gray-500/10">
                            <div className="space-y-2 py-6">
                                ...
                                hover:bg-blue-800"> Flights</a>
                                <a href="#" className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white
                                hover:bg-blue-800"> Car Rentals</a>
                                <a href="#" className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white
                                hover:bg-blue-800">
                                </a>
                                <a href="#" className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white
                                hover:bg-blue-800"> Flight + Hotel</a>
                            </div>
                            <div className="py-6">
                                <a href="#" className="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-white
                                hover:bg-blue-800"> Log In</a>
                            </div>
                        </div>
                    </div>
                </Dialog.Panel>
